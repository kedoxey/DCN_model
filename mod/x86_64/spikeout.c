...
#define nrn_init _nrn_init__SpikeOut
#define _nrn_initial _nrn_initial__SpikeOut
#define nrn_cur _nrn_cur__SpikeOut
#define _nrn_current _nrn_current__SpikeOut
#define nrn_jacob _nrn_jacob__SpikeOut
#define nrn_state _nrn_state__SpikeOut
#define _net_receive _net_receive__SpikeOut 
...
#define vrefrac vrefrac_SpikeOut
 ...
 "thresh_SpikeOut", "millivolt",
 "refrac_SpikeOut", "ms",
 "vrefrac_SpikeOut", "millivolt",
 "grefrac_SpikeOut", "microsiemens",
 "i", "nanoamp",
 0,0
};
 /* connect global user variables to hoc */
 static DoubScal hoc_scdoub[] = {
 "thresh_SpikeOut", &thresh_SpikeOut,
 "refrac_SpikeOut", &refrac_SpikeOut,
 "vrefrac_SpikeOut", &vrefrac_SpikeOut,
 "grefrac_SpikeOut", &grefrac_SpikeOut,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 SpikeOut /Users/katedoxey/Desktop/research/projects/tinnitus model/code/DCN_model/mod/spikeout.mod\n");
...
static void initmodel(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt) {
  int _i; double _save;{
 {
   net_send ( _tqitem, (double*)0, _ppvar[1]._pvoid, t +  0.0 , 3.0 ) ;
   g = 0.0 ;
   }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/katedoxey/Desktop/research/projects/tinnitus model/code/DCN_model/mod/spikeout.mod";
static const char* nmodl_file_text = 
  "NEURON {\n"
  ...
  "	grefrac = 20 (microsiemens) :clamp to vrefrac\n"
  "}\n"
  "\n"
  "ASSIGNED {\n"
  "	i (nanoamp)\n"
